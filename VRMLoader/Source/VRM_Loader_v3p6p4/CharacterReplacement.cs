...
namespace VRM_Loader
{
    ...
    {
        private static AssetBundle _assetsData;
        private static AssetBundle _shaderData;

        private static bool _modelUpdate;
        private static string _status;
        private static GameObject _vrmModel;
        private static PlayerSetupBase _preLocalPlayer;
        ...
        public static void Update(ITimeStep t)
        {
            ...
            if (localPlayer != _preLocalPlayer)
            {
                ...
                _modelUpdate = _preLocalPlayer != null;
            }
