        ...
        public override void Build()
        {
            ...
            SubjectiveButton<Mimic> subjectiveButton_3 = hUi_1.AddButton("Mirror data transfer", "Transfer the data to the mimic block on the other side of the mirror mode.",
                (Mimic I) =>
                {
                    ...
                    if (targetMimic != null)
                    {
                        MimicAndDecoration_CommonData Mdata = new MimicAndDecoration_CommonData(_focus);
                        MimicAndDecoration_CommonData Tdata = new MimicAndDecoration_CommonData(targetMimic);
                        MimicAndDecoration_CommonData.Copy(Mdata, Tdata);
