...
namespace AdvancedMimicUi
{
    public static class HuwaMimicHelp
    {
        ...
        public static void XAxisFlip(MimicAndDecoration_CommonData data)
        {
        ...
        public static void YAxisFlip(MimicAndDecoration_CommonData data)
        {
        ...
        public static void ZAxisFlip(MimicAndDecoration_CommonData data)
        {
