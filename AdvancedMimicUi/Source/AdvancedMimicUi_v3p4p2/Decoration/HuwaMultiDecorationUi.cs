...
namespace AdvancedMimicUi
{
    public class HuwaMultiDecorationUi : MultiDecorationEditor
    {
        ...
        protected override ConsoleWindow BuildInterface(string suggestedName = "")
        {
            ...
            consoleWindow_1 = NewWindow(1, "Pick a mesh", new ScaledRectangle(10f, 435f, 600f, 340f));
            consoleWindow_1.DisplayTextPrompt = false;
            consoleWindow_1.MinimumWindowHeight = new PixelSizing(35f, Dimension.Height);
            consoleWindow_1.SetMultipleTabs(new HuwaDecorationMeshSelectTab(consoleWindow_1, this));

            consoleWindow_2 = NewWindow(2, "Other", new ScaledRectangle(670f, 10f, 600f, 230f));
            consoleWindow_2.DisplayTextPrompt = false;
            consoleWindow_2.MinimumWindowHeight = new PixelSizing(35f, Dimension.Height);
            consoleWindow_2.SetMultipleTabs(new HuwaDecorationPositioningTab(consoleWindow_2, this), new CalculationSuperScreen(consoleWindow_2), new HuwaDecorationTriangleGeneratorTab(consoleWindow_2, this), new HuwaDecorationSettingsTab(consoleWindow_2, _focus));
