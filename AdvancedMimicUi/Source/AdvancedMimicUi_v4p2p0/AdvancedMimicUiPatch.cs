...
namespace AdvancedMimicUi
{
    internal class AdvancedMimicUiPatch
    {
        ...
        private class Mimic_AppendToolTip_Patch
        {
            ...
            {
                string name = HuwaHelpFunctions.GetItemName(__instance.Data.MeshGuid);
        ...
        [HarmonyPatch(typeof(DecorationsSubject), "SpawnDecorationWidget")]
        private class DecorationsSubject_SpawnDecorationWidget_Patch
        {
            private static void Postfix(DecorationsSubject __instance)
            {
                __instance._camera.CanSelect = (() => __instance.Ui.Windows.All(I => !I.MouseOnScreenLastOnGui));
            }
        }
