...
{
    public class HuwaDecorationSettingsTab : HuwaSettingsTab
    {
        private DecorationsSubject _decorationsSubject;

        public HuwaDecorationSettingsTab(ConsoleWindow window, DecorationsSubject decorationsSubject) : base(window)
        {
            _decorationsSubject = decorationsSubject;
        }
        ...
        public override void Build()
        {
            ...
            HuwaUi<DecorationsSubject> hUi = new HuwaUi<DecorationsSubject>(_decorationsSubject);
            ...
            screenSegment_0.AddInterpretter(SubjectiveDisplay<int>.Quick(default, M.m<int>(I => $"Number of decorations in the 'Construct'  :  <<{_decorationsSubject.ConstructDecorations.DecorationCount} / 5000>>")));
        }
    }
}
