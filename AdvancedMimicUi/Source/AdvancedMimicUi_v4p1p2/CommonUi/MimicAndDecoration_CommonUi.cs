...
namespace AdvancedMimicUi
{
    public static class MimicAndDecoration_CommonUi
    {
        ...
        public static ScreenSegmentTable BarsUiGeneration(ConsoleUiScreen screen, HuwaUi<MimicAndDecorationCommonData> hUi_0, bool advPositioning = false)
        {
            ...
            foreach (SubjectiveFloatClampedWithBarFromMiddle<MimicAndDecorationCommonData> s in subjectiveFloats)
            {
        ...
        public static SubjectiveToggle<Decoration> GetHideOriginalMeshToggle(Decoration focus)
        {
            ToolTip toolTip = new ToolTip(DecorationTab._locFile.Get("Toggle_HideOriginalMesh_Tip", "If true, the mesh of the block we are tethering to will be hidden. Only works for static blocks."));

            SubjectiveToggle<Decoration> subjectiveToggle = SubjectiveToggle<Decoration>.Quick(focus, DecorationTab._locFile.Get("Toggle_HideOriginalMesh", "Hide original mesh"), toolTip,
                (Decoration I, bool b) =>
                {
                    I.SetHideOriginalMesh(b);
                },
                (Decoration I) =>
                {
                    return I.GetHideOriginalMesh();
                });

            return subjectiveToggle;
        }

        public static SubjectiveToggle<DecorationsSubject> GetHideOriginalMeshToggle(DecorationsSubject focus)
        {
            ToolTip toolTip = new ToolTip(DecorationTab._locFile.Get("Toggle_HideOriginalMesh_Tip", "If true, the mesh of the block we are tethering to will be hidden. Only works for static blocks."));

            SubjectiveToggle<DecorationsSubject> subjectiveToggle = SubjectiveToggle<DecorationsSubject>.Quick(focus, DecorationTab._locFile.Get("Toggle_HideOriginalMesh", "Hide original mesh"), toolTip,
