    ...
    public class HuwaMultiDecorationEditorTab : MultiDecorationEditorTab
    {
        ...
        public override void Build()
        {
...

            {
                ...
                screenSegment_3.SqueezeSides = true;
                screenSegment_3.AddInterpretter(MimicAndDecoration_CommonUi.GetHideOriginalMeshToggle(_focus));
...

            {
                ...
                ScreenSegmentStandard screenSegment_6 = CreateStandardSegment();
                screenSegment_6.SpaceAbove = 60f;
                screenSegment_6.AddInterpretter(subjectiveButton_5);
            }
