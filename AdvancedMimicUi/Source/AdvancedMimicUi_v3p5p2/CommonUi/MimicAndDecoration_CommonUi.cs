...
namespace AdvancedMimicUi
{
    public static class MimicAndDecoration_CommonUi
    {
        ...
        public static void BarsUiGeneration(ScreenSegmentTable screenSegmentTable, HuwaUi<MimicAndDecorationCommonData> hUi_0, bool advPositioning = false)
        {
            ...
            subjectiveFloats[0] = SubjectiveFloatClampedWithBarFromMiddle<MimicAndDecorationCommonData>.Quick(
                hUi_0.Focus, -10f, 10f, 0.05f, 0f, M.m<MimicAndDecorationCommonData>(I => I.Positioning.x), "Left right positioning {0}", (I, f) => I.PositioningX = f, new ToolTip("Adjust the left right positioning of the mesh"));
            subjectiveFloats[1] = SubjectiveFloatClampedWithBarFromMiddle<MimicAndDecorationCommonData>.Quick(
                hUi_0.Focus, -10f, 10f, 0.05f, 0f, M.m<MimicAndDecorationCommonData>(I => I.Positioning.y), "Up down positioning {0}", (I, f) => I.PositioningY = f, new ToolTip("Adjust the up down positioning of the mesh"));
            subjectiveFloats[2] = SubjectiveFloatClampedWithBarFromMiddle<MimicAndDecorationCommonData>.Quick(
                hUi_0.Focus, -10f, 10f, 0.05f, 0f, M.m<MimicAndDecorationCommonData>(I => I.Positioning.z), "Forward backward positioning {0}", (I, f) => I.PositioningZ = f, new ToolTip("Adjust the forward backward positioning of the mesh"));
